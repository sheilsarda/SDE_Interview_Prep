...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/SDE_Interview_Prep/ROS2.0_Chess/install/player"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/player/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/player/environment/path.sh"
